  ...
  describe 'Home page' do
    ...
    before :each do
     ...
     fill_in 'Password', with: 'password'
		 click_button 'Log in'
	 	 @food = Group.create(id: 1, name: 'Food', icon: 'https://cdn-icons-png.flaticon.com/512/5141/5141534.png', author_id: @user.id )
		 @clothing = Group.create(id: 2, name: 'Clothing', icon: 'https://cdn-icons-png.flaticon.com/512/5141/5141534.png', author_id: @user.id )
		 @dress = Entity.create(id: 1, name: 'dress', amount: 50, author_id: @user.id)
